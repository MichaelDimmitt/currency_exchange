...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference("Currency.count") do
      post currencies_url, params: { currency: { currency_symbol: @currency.currency_symbol, iso_code: @currency.iso_code, name: @currency.name } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { currency_symbol: @currency.currency_symbol, iso_code: @currency.iso_code, name: @currency.name } }
